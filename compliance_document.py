...
baseRes = ElementTree.parse(
    '{}/schema/base/**/ResCompliance.xsd'.format(target_folder)).getroot()
baseNr = ElementTree.parse(
    '{}/schema/base/**/NrPresCompliance.xsd'.format(target_folder)).getroot()
base = baseRes if baseRes is not None else baseNr
tag_dict = {
